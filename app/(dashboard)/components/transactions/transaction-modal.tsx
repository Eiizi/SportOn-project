    ...
    return(
        <Modal isOpen={isOpen} onClose={onClose} title="Verify Transactions">
            <div className="flex gap-6">
                ...
                <Image src="/images/payment-proof-dummy.png"
                alt="payment proof" 
                width={200} 
                height={401}
                />
            ...
            <div>
               ...
               <div className="border border-gray-200 rounded lg p-2 flex items-center gap-2">
                <div className="bg-gray-100 runded aspect-square w-8 h-8">
                ...
                <div className="font-medium text-sm">SportOn Hyperfast Shooes</div>
