...
const CategoryModal = ({isOpen, onClose, onSuccess,category}: TCategoryModalProps)=> {
    ...
    return(
        <Modal isOpen={isOpen} onClose={onClose} title={isEditMode ? "Edit New Category": "Add New Category"}>
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                <div className="flex gap-7">
                    <div className="min-w-50">
                        <ImageUploadPreview label="Category Image" value={imagePreview ?? undefined} onChange={
                            (file) => {
                                setImageFile(file);
